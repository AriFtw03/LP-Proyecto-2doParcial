...
CREATE TABLE IF NOT EXISTS adopciones (
    ...
    ciudad_direccion VARCHAR(150) NOT NULL,
    tipo_vivienda ENUM('casa_propia', 'casa_alquiler', 'departamento_propio', 'departamento_alquiler', 'otro') NOT NULL,
    tiene_patio_espacio TINYINT(1) NOT NULL DEFAULT 0,
    otras_mascotas TINYINT(1) NOT NULL DEFAULT 0,
    descripcion_otras_mascotas VARCHAR(200) DEFAULT NULL,
    experiencia_previa ENUM('primera_vez', 'ha_tenido_antes', 'cuidador_experimentado') NOT NULL DEFAULT 'ha_tenido_antes',
